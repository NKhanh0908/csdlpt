...
CREATE TABLE bangchamcong (
  ...
  TANGCA_CHECKIN TIME NULL,
  AUTO_CHECKOUT BIT DEFAULT 0
);
SET IDENTITY_INSERT dbo.bangchamcong ON

INSERT INTO bangchamcong (idCC, idNV, NGAYLAM, CHECKIN, CHECKOUT, HESO, idNGAYLE, TANGCA, TANGCA_CHECKIN, AUTO_CHECKOUT)
VALUES
...
CREATE TABLE lsuthangchuc (
  idTC INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
  idTK INT NOT NULL, 
  vitricu INT NULL, 
  vitrimoi INT NOT NULL,
  luongcu INT NOT NULL,
  luongmoi INT NOT NULL,
...
(3, 30, 2, 5, 0, 0, '2025-03-28', 1),
(4, 29, 2, 7, 0, 0, '2025-03-28', 0);
SET IDENTITY_INSERT dbo.lsuthangchuc OFF


CREATE TABLE bangluong (
  idLUONG int IDENTITY(1,1) PRIMARY KEY NOT NULL,
  idNV int NOT NULL,
...
CREATE TABLE chitietgiohang (
  ...
  THOIGIANTHEM DATETIME2 NOT NULL DEFAULT GETDATE(),
);
...
(3, 3, 18000000, '2024-03-20', N'789 Nguyen Trai, Q3, TP HCM', 1, 3, 1, 1, 1),
(4, 4, 22000000, '2024-04-05', N'159 Vo Van Kiet, Q6, TP HCM', 3, 2, 1, 2, 1),
(5, 5, 3000000, '2024-05-12', N'753 Phan Xich Long, Q. Phu Nhuan', 2, 1, 1, 1, 1),
(6, 10, 32820000, '2025-02-24', N'HoChiMinh', 1, 1, 1, 1, 1),
(7, 10, 23925000, '2025-02-24', N'HoChiMinh', 1, 2, 1, 1, 1),
(8, 10, 68804000, '2025-02-24', N'HoChiMinh', 1, 4, 4, 1, 1),
(9, 11, 32820000, '2025-02-26', N'HoChiMinh', 1, 1, 1, 1, 1),
(10, 11, 131190000, '2025-02-28', N'HoChiMinh', 1, 1, 1, 1, 1),
(11, 11, 46820000, '2025-02-28', N'HoChiMinh', 1, 6, 1, 1, 1),
(12, 11, 6210000, '2025-02-28', N'HoChiMinh', 1, 3, 1, 1, 2),
(13, 11, 23920000, '2025-02-28', N'HoChiMinh', 1, 3, 1, 1, 2),
(14, 11, 19030000, '2025-02-28', N'HoChiMinh', 1, 1, 1, 1, 2),
(15, 11, 23930000, '2025-02-28', N'HoChiMinh', 1, 1, 1, 1, 2),
(16, 11, 35040000, '2025-02-28', N'HoChiMinh', 1, 6, 1, 1, 2),
(22, 11, 35030000, '2025-03-01', N'HoChiMinh', NULL, 1, 1, 1, 2),
(23, 11, 35030000, '2025-03-01', N'HoChiMinh', NULL, 1, 1, 1, 2),
(24, 11, 32820000, '2025-03-01', N'HoChiMinh', NULL, 1, 1, 1, 2),
(25, 11, 35030000, '2025-03-01', N'HoChiMinh', NULL, 1, 1, 1, 2),
(26, 11, 32820000, '2025-03-01', N'HoChiMinh', NULL, 1, 1, 1, 2),
(27, 11, 19025000, '2025-03-01', N'HoChiMinh', NULL, 2, 1, 1, 3),
(28, 11, 32810000, '2025-03-01', N'HoChiMinh', NULL, 3, 1, 1, 3),
(29, 11, 32810000, '2025-03-01', N'HoChiMinh', NULL, 3, 1, 1, 3),
(30, 11, 23925000, '2025-03-01', N'HoChiMinh', NULL, 4, 1, 1, 3),
(31, 11, 5615000, '2025-03-01', N'HoChiMinh', NULL, 2, 1, 1, 3),
(32, 11, 20385000, '2025-03-01', N'HoChiMinh', 4, 2, 1, 1, 3),
(33, 11, 35030000, '2025-03-01', N'HoChiMinh', 5, 1, 1, 1, 3),
(34, 11, 7989000, '2025-03-01', N'HoChiMinh', 2, 3, 1, 1, 3),
(35, 11, 35000000, '2025-03-01', N'HoChiMinh', 5, 1, 1, 1, 3),
(36, 11, 7999000, '2025-03-01', N'HoChiMinh', 5, 1, 1, 1, 3);
...
(5, 'SUMMER30', 30000, 10, '2024-05-01', '2024-09-30', 1);
...
CREATE TABLE ngayle (
  idNGAYLE int IDENTITY(1,1) PRIMARY KEY NOT NULL,
  NGAY date NOT NULL,
  TENNGAYLE Nvarchar(100) NOT NULL
);

SET IDENTITY_INSERT dbo.ngayle ON;
INSERT INTO ngayle (idNGAYLE, NGAY, TENNGAYLE) VALUES
(1, '2025-04-30', N'Ngày giải phóng Miền Nam'),
(2, '2025-03-03', N'Ngày nghỉ dưỡng');
SET IDENTITY_INSERT dbo.ngayle OFF;
--
...
CREATE TABLE quyen (
  idQUYEN int IDENTITY(1,1) PRIMARY KEY NOT NULL ,
...
(3, N'Nhân viên kho', 1000000, 1),
(4, N'Quản lý nhân sự', 1000000, 1),
(5, N'Kế toán', 1000000, 1),
(6, N'Quản lý nhập hàng', 1000000, 1),
(7, N'Shipper', 1000000, 1);
...
CREATE TABLE rating (
  ...
  comment Ntext DEFAULT NULL,
  has_image tinyint DEFAULT 0,
  purchase_verified tinyint DEFAULT 0,
  created_at DATETIME2 NOT NULL DEFAULT GETDATE()
);

SET IDENTITY_INSERT dbo.rating ON
INSERT INTO rating (id, idSP, idTK, rating, comment, has_image, purchase_verified, created_at) VALUES
(1, 1, 2, 5, N'Sản phẩm tốt', 0, 0, '2025-02-21 08:12:13'),
(2, 2, 1, 3, N'', 0, 0, '2025-02-21 08:15:06'),
(3, 3, 6, 3, N'', 0, 0, '2025-02-21 08:51:43'),
(4, 2, 6, 5, N'ewf 3r gf', 0, 0, '2025-02-21 12:21:23'),
(5, 4, 6, 5, '', 0, 0, '2025-02-21 08:52:46'),
(6, 28, 6, 5, N'ewfefe', 0, 0, '2025-02-21 08:53:12'),
(7, 7, 6, 3, '', 0, 0, '2025-02-21 08:54:57'),
(8, 1, 7, 1, '', 0, 0, '2025-02-21 10:07:01'),
(9, 3, 7, 5, N'sp tott', 0, 0, '2025-02-21 13:33:06'),
(10, 2, 7, 5, N'dfnjnrgf', 0, 0, '2025-02-21 12:20:20'),
(11, 4, 7, 1, '', 0, 0, '2025-02-21 09:48:11'),
(12, 2, 8, 4, N'sp tooo', 0, 0, '2025-02-21 12:38:13'),
...
CREATE TABLE hoantien (
  idHT int IDENTITY(1,1) PRIMARY KEY NOT NULL,
  idHD int NOT NULL,
  idTK int NOT NULL,
  AMOUNT float NOT NULL,  
  NGAYHOAN datetime NOT NULL DEFAULT GETDATE(),
  TRANGTHAI tinyint NOT NULL DEFAULT 1
);
...
ALTER TABLE bangchamcong
  ADD CONSTRAINT [nv-cc] FOREIGN KEY (idNV) REFERENCES nhanvien (idTK);
...
ALTER TABLE lsuthangchuc
  ADD CONSTRAINT vtmoi_lsu FOREIGN KEY (vitrimoi) REFERENCES quyen (idQUYEN);
ALTER TABLE donhang
...
ALTER TABLE hoantien
  ADD CONSTRAINT [hd_ht] FOREIGN KEY (idHD) REFERENCES donhang (idHD);
ALTER TABLE hoantien
  ADD CONSTRAINT [tk_ht] FOREIGN KEY (idTK) REFERENCES taikhoan (idTK);
