...
CREATE TABLE bangchamcong (
  idNV int NOT NULL,
  NGAYLAM DATETIME2 NOT NULL DEFAULT GETDATE(),
  HESO int NOT NULL DEFAULT 1,
  idNGAYLE int DEFAULT NULL
);

INSERT INTO bangchamcong (idNV, NGAYLAM, HESO, idNGAYLE) VALUES
(12, '2025-03-03 09:56:20', 2, 2),
(12, '2025-03-03 09:56:20', 2, 2),
(12, '2025-03-03 09:56:26', 2, 2);
...
(0, N'Khách hàng', 1),
(1, N'admin', 1),
(2, N'Nhân viên bán hàng', 1),
(3, N'Nhân viên kho', 1),
(4, N'Quản lý nhân sự', 1),
(5, N'Kế toán', 1),
(6, N'Quản lý nhập hàng', 1),
(7, N'Shipper', 1);
